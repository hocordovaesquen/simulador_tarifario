...
def leer_negociacion(archivo):
    """Lee la hoja A3. Negociacion"""
    df = pd.read_excel(archivo, sheet_name='A3. Negociacion', header=0)
...
def leer_parametros(archivo):
    """Lee la hoja Parametros desde columna R hacia adelante"""
    df = pd.read_excel(archivo, sheet_name='Parametros', header=None)
